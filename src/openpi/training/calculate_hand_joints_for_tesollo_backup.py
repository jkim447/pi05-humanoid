...
def _pose_cam_pos6_offset(f, name: str, t: int):
    """
...
def hand_joint_cmd20_from_h5(f, name: str, t: int):
    ...
    return:
    the 20 joint commands for left hand or the right hand (depending on what 'name' is)
    """

    if name == "leftHand":
        # pos and rot of left hand in camera frame
        pos, rot = _pose_cam_pos6_offset(f, name, t)
    elif name == "rightHand":
        pos, rot = _pose_cam_pos6_offset(f, name, t)
